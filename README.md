...
### 소스코드 다운로드
* day1.zip
* [Download Pages](https://github.com/uzoolove/js202010/blob/main/sample/day1.zip){: target="_blank"} 이동 후 Download 버튼 클릭
...
> node webserver.js
```
5. 크롬 브라우저 주소창에 http://localhost{: target="_blank"} 입력
...
## 소스코드 다운로드
* day2.zip
* [Download Pages](https://github.com/uzoolove/js202010/blob/main/sample/day2.zip){: target="_blank"} 이동 후 Download 버튼 클릭
...
## 소스코드 다운로드
* day3.zip
* [Download Pages](https://github.com/uzoolove/js202010/blob/main/sample/day3.zip){: target="_blank"} 이동 후 Download 버튼 클릭
* 다운로드 받은 파일을 C 드라이브 root에 압축 해제(기존 파일 덮어쓰기)
  * C:\jslab\etc
  * C:\jslab\index.html
...
## 소스코드 다운로드
* day4.zip
* [Download Pages](https://github.com/uzoolove/js202010/blob/main/sample/day4.zip){: target="_blank"} 이동 후 Download 버튼 클릭
* 다운로드 받은 파일을 C 드라이브 root에 압축 해제(기존 파일 덮어쓰기)
  * C:\jslab\ch05
  * C:\jslab\ch06
  * C:\jslab\etc
